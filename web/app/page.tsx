  ...
  const stats = [
    {
      ...
      value: overview ? formatCompact(overview.usable_comments, locale) : "-",
    },
    {
      label: t.home.statIssues,
      value: issues ? formatNumber(issues.issues.length, locale) : "-",
    },
    {
      label: t.home.statFlagged,
      value: risk ? formatNumber(risk.total_flagged, locale) : "-",
    },
  ];
