...
const en = {
  ...
  dashboard: {
    ...
    engagementPresent: "Engagement fields present in source",
    engagementAbsent: "No engagement fields in source",
  ...
  sentiment: {
    ...
    metricMajorityBaseline: "Majority-class baseline ({label})",
  ...
  risk: {
    ...
    highRisk: "High risk",
    highRiskSub: "Score 40-59",
    needsVerification: "Needs verification",
    needsVerificationSub: "Score 60-100",
    ...
    explorerSub:
      "Sample of flagged comments from the dataset, sorted by risk score. Each row lists the cues that triggered the signal.",
    explorerSample: "Showing {shown} of {total} flagged comments in this sample.",
...
const id: Dictionary = {
  ...
  dashboard: {
    ...
    engagementPresent: "Field engagement tersedia di sumber data",
    engagementAbsent: "Tidak ada field engagement di sumber data",
  ...
  sentiment: {
    ...
    metricMajorityBaseline: "Baseline kelas mayoritas ({label})",
    metricMacroF1: "Macro F1",
  ...
  risk: {
    ...
    highRisk: "Risiko tinggi",
    highRiskSub: "Skor 40-59",
    needsVerification: "Perlu verifikasi",
    needsVerificationSub: "Skor 60-100",
    ...
    explorerSub:
      "Sampel komentar ditandai dari dataset, diurutkan berdasarkan skor risiko. Tiap baris mencantumkan indikasi pemicu sinyal.",
    explorerSample: "Menampilkan {shown} dari {total} komentar ditandai pada sampel ini.",
  ...
  cards: {
    ...
    recommendedActions: "Aksi yang disarankan",
    limitations: "Keterbatasan",
    evidence: "Bukti",
    linkedIssues: "Isu terkait",
    priorityHigh: "Tinggi",
